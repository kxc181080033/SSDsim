...
struct ssd_info *no_buffer_distribute_sch(struct ssd_info *); //KXC:the time updating of shedule
struct ssd_info *no_buffer_distribute_nosch(struct ssd_info *); //KXC:the same logic to the original code and contain time updating
