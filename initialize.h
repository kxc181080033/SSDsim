...
struct ssd_info{ 
	...
	unsigned long predict_count;         //KXC_2：to record the predict times
	unsigned long predict_yes;           //KXC_2：to record the predict yes times
...
struct plane_info{
	...
	unsigned int hot_block;            //3
	unsigned int hot2_block;            //2
	unsigned int cold2_block;           //1
	unsigned int cold_block;           //0
...
struct parameter_value{
	...
	int time_control;				//KXC_2：to set the time control
